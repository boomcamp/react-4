  ...
  render() {
    return (
      <div>
        ...
        <Link to = "/about" className="subnav_links">About</Link>
        <Link to = "/about/history" className="subnav_links">History</Link>
        <Link to = "/about/contact" className="subnav_links">Contact</Link>
        </div>
        <div className="box"> 
        <Switch>
          <Route path="/about/history" component ={History} className="subnav_links" />
          <Route path="/about/contact" component = {Contact} className="subnav_links" />
          <Route
              exact
              path="/about"
              render={() => (
